    ...
    public partial class frmClientes : Form
    {
        ...
        private void frmClientes_Load(object sender, EventArgs e)
        {
            ...
            foreach (Cliente item in lista)
            {
                ...
                dgvdata.Rows.Add(new object[] {"",item.IdCliente,item.Documento,item.NombreCompleto,item.Correo,item.Telefono, //item es cada entidad de la clase usuario en la lsita
        ...
        private void btnguardcli_Click(object sender, EventArgs e)
        {
            ...
            Cliente obj = new Cliente() //instancia de la clase usuario en capa entidad
            {
            ...
            {
                bool resultado = new CN_Cliente().Editar(obj, out mensaje);//si no es 0 va a editar
