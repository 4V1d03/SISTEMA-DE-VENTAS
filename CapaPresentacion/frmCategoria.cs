...
namespace CapaPresentacion
{
    public partial class frmCategoria : Form
    {
        ...
        private void btnguardarusuario_Click(object sender, EventArgs e)
        {
            ...
            Categoria obj = new Categoria() //instancia de la clase usuario en capa entidad
            {
            ...
            {
                bool resultado = new CN_Categoria().Editar(obj, out mensaje);//si no es 0 va a editar
